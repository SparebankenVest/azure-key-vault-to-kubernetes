...
type SharedInformerFactory interface {
	...
	Azurekeyvaultcontroller() azurekeyvaultcontroller.Interface
}

func (f *sharedInformerFactory) Azurekeyvaultcontroller() azurekeyvaultcontroller.Interface {
	return azurekeyvaultcontroller.New(f, f.namespace, f.tweakListOptions)
}
