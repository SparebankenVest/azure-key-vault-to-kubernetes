...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=azurekeyvaultcontroller.spv.no, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("azurekeyvaultsecrets"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Azurekeyvaultcontroller().V1alpha1().AzureKeyVaultSecrets().Informer()}, nil
