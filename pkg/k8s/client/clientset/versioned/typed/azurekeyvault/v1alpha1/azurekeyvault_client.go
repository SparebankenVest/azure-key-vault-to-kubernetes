...
// AzureKeyVaultV1alpha1Client is used to interact with features provided by the spv.no group.
...
// NewForConfigAndClient creates a new AzureKeyVaultV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AzureKeyVaultV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
