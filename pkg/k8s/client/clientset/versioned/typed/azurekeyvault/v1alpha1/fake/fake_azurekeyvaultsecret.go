...
var azurekeyvaultsecretsResource = v1alpha1.SchemeGroupVersion.WithResource("azurekeyvaultsecrets")

var azurekeyvaultsecretsKind = v1alpha1.SchemeGroupVersion.WithKind("AzureKeyVaultSecret")
