...
type AzureKeyVaultSecretInterface interface {
	Create(*v2beta1.AzureKeyVaultSecret) (*v2beta1.AzureKeyVaultSecret, error)
	Update(*v2beta1.AzureKeyVaultSecret) (*v2beta1.AzureKeyVaultSecret, error)
	UpdateStatus(*v2beta1.AzureKeyVaultSecret) (*v2beta1.AzureKeyVaultSecret, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v2beta1.AzureKeyVaultSecret, error)
	List(opts v1.ListOptions) (*v2beta1.AzureKeyVaultSecretList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2beta1.AzureKeyVaultSecret, err error)
...
func (c *azureKeyVaultSecrets) Get(name string, options v1.GetOptions) (result *v2beta1.AzureKeyVaultSecret, err error) {
...
func (c *azureKeyVaultSecrets) List(opts v1.ListOptions) (result *v2beta1.AzureKeyVaultSecretList, err error) {
...
func (c *azureKeyVaultSecrets) Create(azureKeyVaultSecret *v2beta1.AzureKeyVaultSecret) (result *v2beta1.AzureKeyVaultSecret, err error) {
	result = &v2beta1.AzureKeyVaultSecret{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azurekeyvaultsecrets").
...
func (c *azureKeyVaultSecrets) Update(azureKeyVaultSecret *v2beta1.AzureKeyVaultSecret) (result *v2beta1.AzureKeyVaultSecret, err error) {
	result = &v2beta1.AzureKeyVaultSecret{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azurekeyvaultsecrets").
...
func (c *azureKeyVaultSecrets) UpdateStatus(azureKeyVaultSecret *v2beta1.AzureKeyVaultSecret) (result *v2beta1.AzureKeyVaultSecret, err error) {
	result = &v2beta1.AzureKeyVaultSecret{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azurekeyvaultsecrets").
...
func (c *azureKeyVaultSecrets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2beta1.AzureKeyVaultSecret, err error) {
	result = &v2beta1.AzureKeyVaultSecret{}
