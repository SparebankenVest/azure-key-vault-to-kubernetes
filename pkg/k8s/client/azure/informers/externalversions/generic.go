...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=identity.azure.spv.no, Version=v1beta1
	case v1beta1.SchemeGroupVersion.WithResource("azuremanagedidentities"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Identity().V1beta1().AzureManagedIdentities().Informer()}, nil
