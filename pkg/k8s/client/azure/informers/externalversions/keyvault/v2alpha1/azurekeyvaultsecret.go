...
import (
	...
	keyvaultv2alpha1 "github.com/SparebankenVest/azure-key-vault-to-kubernetes/pkg/k8s/apis/azure/keyvault/v2alpha1"
	...
	v2alpha1 "github.com/SparebankenVest/azure-key-vault-to-kubernetes/pkg/k8s/client/azure/listers/keyvault/v2alpha1"
...
func NewFilteredAzureKeyVaultSecretInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&keyvaultv2alpha1.AzureKeyVaultSecret{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *azureKeyVaultSecretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&keyvaultv2alpha1.AzureKeyVaultSecret{}, f.defaultInformer)
}
