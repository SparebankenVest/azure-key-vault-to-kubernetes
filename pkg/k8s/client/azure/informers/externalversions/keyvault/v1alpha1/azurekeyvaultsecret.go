...
import (
	...
	keyvaultv1alpha1 "github.com/SparebankenVest/azure-key-vault-to-kubernetes/pkg/k8s/apis/azure/keyvault/v1alpha1"
	...
	v1alpha1 "github.com/SparebankenVest/azure-key-vault-to-kubernetes/pkg/k8s/client/azure/listers/keyvault/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KeyvaultV1alpha1().AzureKeyVaultSecrets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KeyvaultV1alpha1().AzureKeyVaultSecrets(namespace).Watch(options)
			},
		},
		&keyvaultv1alpha1.AzureKeyVaultSecret{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *azureKeyVaultSecretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&keyvaultv1alpha1.AzureKeyVaultSecret{}, f.defaultInformer)
}
