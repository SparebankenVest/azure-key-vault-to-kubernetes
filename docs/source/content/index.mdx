...
When you understand the difference between the Controller and the Injector, and when to use which - walking through some tutorials will get you quickly started.
  
<div>
  <Button
    size="large"
    color={colors.primary}
    as={<Link to="/tutorials/introduction" />}
  >
    Start the tutorials!
  </Button>
 </div>