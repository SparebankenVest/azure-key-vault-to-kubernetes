...
// func (c AzureKeyVaultCertificate) GetPublicPemCert() (string, error) {
...
// func (c AzureKeyVaultCertificate) GetPrivatePemKey() (string, error) {
// 	// TODO: Support cert chains
// 	// secretValue := make(map[string][]byte, 2)
// 	// privateDer, rest := pem.Decode([]byte(c.cert))
// 	// publicDer, _ := pem.Decode(rest)
...
// func (c AzureKeyVaultCertificate) GetPfx() (map[string][]byte, error) {
// 	secretValue := make(map[string][]byte, 2)

// 	// log.Infof("Trying to decode base64 string: %s", pfx)
// 	//
// 	pfxRaw, err := base64.StdEncoding.DecodeString(c.cert)
// 	if err != nil {
...
// 	mergedCert := NewAzureKeyVaultCertificate(mergedPems.String())
// 	return mergedCert.extractPem(), nil
// }
