...
release-controller:
	...
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_INTERNAL_REG)/$(DOCKER_CONTROLLER_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_CONTROLLER_IMAGE):$(DOCKER_INTERNAL_TAG)
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_RELEASE_REG)/$(DOCKER_CONTROLLER_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_CONTROLLER_IMAGE):$(DOCKER_RELEASE_TAG_CONTROLLER)
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_RELEASE_REG)/$(DOCKER_CONTROLLER_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_CONTROLLER_IMAGE):latest
...
release-webhook:
	...
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_INTERNAL_REG)/$(DOCKER_WEBHOOK_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_WEBHOOK_IMAGE):$(DOCKER_INTERNAL_TAG)
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_RELEASE_REG)/$(DOCKER_WEBHOOK_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_WEBHOOK_IMAGE):$(DOCKER_RELEASE_TAG_WEBHOOK)
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_RELEASE_REG)/$(DOCKER_WEBHOOK_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_WEBHOOK_IMAGE):latest
...
release-vaultenv:
	...
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_INTERNAL_REG)/$(DOCKER_VAULTENV_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_VAULTENV_IMAGE):$(DOCKER_INTERNAL_TAG)
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_RELEASE_REG)/$(DOCKER_VAULTENV_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_VAULTENV_IMAGE):$(DOCKER_RELEASE_TAG_VAULTENV)
	docker run --rm --net host -v regctl-conf:/home/appuser/.regctl/ regclient/regctl:latest image copy --referrers $(DOCKER_RELEASE_REG)/$(DOCKER_VAULTENV_IMAGE):$(DOCKER_INTERNAL_TAG) $(DOCKER_RELEASE_REG)/$(DOCKER_VAULTENV_IMAGE):latest
